...
const Pricing: React.FC = () => {
  ...
  const handleWhatsAppClick = (planName: string, price: string): void => {
            ...
            >
              ...
              <div className="text-center">
                ...
                <motion.button
                  ...
                  className={`w-full py-3 md:py-4 px-6 md:px-8 rounded-xl font-semibold transition-colors flex items-center justify-center gap-2 ${
                    plan.isPopular
